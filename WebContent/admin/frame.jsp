			...
			<div class="sub-left-menu scroll" style="width: 20%;">
				<ul class="nav nav-list">
					...
					<li class="active ripple"><a class="tree-toggle nav-header"><span
						...
						<li><a target="frame" href="/admin/flight_add.jsp">添加航班信息</a></li>
							<li><a target="frame" href="/admin/flight_list.jsp">航班信息列表</a></li>
						</ul>
					</li>
					<li class="ripple"><a class="tree-toggle nav-header"> <span
						...
						<ul class="nav nav-list tree">
							<li><a target="frame" href="/admin/order_list.jsp">订单信息列表</a></li>
						</ul>
					</li>
					<li class=" ripple"><a class="tree-toggle nav-header"><span
							...
							class="fa-angle-right fa right-arrow text-right"></span> </a>
						<ul class="nav nav-list tree">
							<li><a target="frame" href="/admin/user_list.jsp">用户信息列表</a></li>
						</ul>
					</li>
					<li class=" ripple"><a class="tree-toggle nav-header"><span class="fa fa-calendar-o"></span></span>留言评论管理<span
							class="fa-angle-right fa right-arrow text-right"></span> </a>
						<ul class="nav nav-list tree">
							<li><a target="frame" href="/admin/feedback_list.jsp">查看留言列表</a></li>
						</ul>
					</li>
				</ul>
			</div>
	...
	<div id="right">
		<div id="right_top">
			...
			<div class="thisUser">
				...
				<div class="logout"><a href="/admin/logout.jsp">退出</a></div>
			</div>
			
		</div>
		<div id="right_bottom">
			<iframe name="frame" scrolling="auto" width="100%" height="100%" frameborder="0" src="/admin/welcome.jsp"></iframe>
		</div>
	</div>
